                          ...
                          {pendingNurses.map((nurse) => (
                            <tr key={nurse.id} className="hover:bg-gray-50">
                              ...
                              <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div className="flex space-x-2">
                                  <button
                                    onClick={() => window.open(`/admin/nurse-review?id=${nurse.id}`, '_blank')}
                                    className="inline-flex items-center px-3 py-1 border border-blue-300 text-xs font-medium rounded-full shadow-sm text-blue-700 bg-blue-50 hover:bg-blue-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors"
                                  >
